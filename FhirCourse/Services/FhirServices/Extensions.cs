...
namespace FhirCourse.Services.FhirServices
{
    ...
    {
        ValueSet PatientTaxSituationValueSet = new ValueSet
        {
            Text = new Narrative
            {
            ...
            Identifier = new List<Identifier>
            {
                new Identifier
                {
                    SystemElement = new FhirUri("http://fhir.hl7fundamentals.org/berzerkistan/identifiers/valuesets"),
            ...
            Contact = new List<ContactDetail>
            {
                new ContactDetail
                {
                    ...
                    Telecom = new List<ContactPoint>
                    {
                        new ContactPoint
                        {
                            SystemElement = new Code<ContactPoint.ContactPointSystem>(ContactPoint.ContactPointSystem.Other),
            ...
            Compose = new ValueSet.ComposeComponent
            {
                Include = new List<ValueSet.ConceptSetComponent>
                {
                   ...
                   {
                       SystemElement = new FhirUri("http://fhir.hl7fundamentals.org/berzerkistan/CodeSystem/PatientTaxSituation"),
                       Concept = new List<ValueSet.ConceptReferenceComponent>
                       {
                           new ValueSet.ConceptReferenceComponent {CodeElement = new Code("U"), Display = "UNCOVERED"},
                           new ValueSet.ConceptReferenceComponent {CodeElement = new Code("V"), Display = "VOLUNTARY"},
                           new ValueSet.ConceptReferenceComponent {CodeElement = new Code("M"), Display = "MANDATED"},
                       }
                   }
                }
            }
        ...
        public CodeSystem PatientTaxSituationCodeSystem = new CodeSystem
        {
            NameElement = new FhirString("Berzerkistan PPH Tax Situation - 20151120"),
            Meta = new Meta
            {
            ...
            {
                StatusElement = new Code<Narrative.NarrativeStatus>(Narrative.NarrativeStatus.Generated),
                Div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h2>Berzerkistan PPH Tax Situation - 20151120</h2><tt>http://fhir.hl7fundamentals.org/berzerkistan/CodeSystem/PatientTaxSituation</tt><p>Code System PPH Table Berzerkistan PPH Patient Tax Situation</p></div>"
            },
            ...
            Identifier = new List<Identifier>
            {
                new Identifier
                {
                    SystemElement = new FhirUri("http://fhir.hl7fundamentals.org/berzerkistan/identifiers/codesystems"),
                    ValueElement = new FhirString("PatientTaxSituation")
                }
            },
